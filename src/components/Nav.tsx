        ...
        <nav className="sticky top-0 z-50 bg-white border-b border-gray-200">
            <div className="container mx-auto px-6 h-20 flex items-center justify-between">
                ...
                <div className="flex items-center gap-5 text-xl font-semibold">
                    <button className="text-gray-700 cursor-pointer hover:text-pink-500">
                        Sign In
                    </button>

                    <button className="bg-pink-600 cursor-pointer text-white px-5 py-2.5 rounded-full font-semibold hover:bg-pink-700">
                        Sign Up
                    </button>
                </div>

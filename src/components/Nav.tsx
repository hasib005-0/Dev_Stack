        ...
        <nav className="sticky top-0 z-50 bg-white border-b border-gray-200">
            <div className="container mx-auto px-4 sm:px-6 h-20 flex items-center justify-between relative">
                ...
                <img
                    src={Logo}
                    alt="Dev Stack"
                    className="w-32 sm:w-40 md:w-40 md:static absolute left-1/2 -translate-x-1/2 md:translate-x-0 md:left-auto"
                />
                ...
                <div className="flex items-center gap-2 sm:gap-4 md:gap-5 font-semibold">
                    ...
                    <button className="brand-gradient cursor-pointer text-white px-3 sm:px-5 py-2 sm:py-2.5 rounded-full font-semibold hover:opacity-90 text-sm sm:text-base md:text-xl">
                        Sign Up
                    </button>
